 ...
 * 
 */
public class CopyOfDataBaseConfiguration extends AbstractConfiguration {
	 ...
	 * @param artifactId
	 */
	public CopyOfDataBaseConfiguration(String environment, String groupId,
			String artifactId) {
		super();
	...
	public CopyOfDataBaseConfiguration( String groupId, String artifactId) {
...
//			handle.setService(this);
	...
	public static void main(String[] args) {
		CopyOfDataBaseConfiguration configuration =
				new CopyOfDataBaseConfiguration("com.glue", "test");
		String key = "shuzu";
		// add
